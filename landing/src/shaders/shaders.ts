// Noise-displaced icosahedron shader for the hero. Inlined as strings so it works under Turbopack
// without a glsl loader. cnoise is the classic Perlin noise (Stefan Gustavson) implementation.
...
void main() {
    ...
    float elevation = cnoise(position + uTime * 0.5) * 0.4;
...
void main() {
    ...
    vec4 colorAccent = mix(c3, c4, v);
    gl_FragColor = mix(colorPrimary, colorAccent, uColorChange);
}
`;
