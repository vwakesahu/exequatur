...
// Adapted from the LiveKit Agents UI hook: the original blended live audio volume into the shader
// while `speaking`. We have no audio track, so this is purely state-driven - the shader still reacts
// to idle / thinking / speaking, just without a microphone level.
